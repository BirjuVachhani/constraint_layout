  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            // One SelectionArea for the whole page body (not the nav overlay),
            // so a code block's selection and its Cmd/Ctrl+C copy are driven by a
            // single region. The pages no longer wrap their own, and code blocks
            // detect this ancestor and don't nest another (nested regions break
            // keyboard copy). The nav stays outside so its chrome isn't
            // selectable.
            child: SelectionArea(
